...
export const handleSaveBackup = () => {
    ...
    btnSaveWeb.addEventListener('click', () => {
        // Prepare app data and suggested friendly name, but allow the user to edit it
        const appData = getAllAppData();
        ...
        confirmBtn.addEventListener('click', () => {
            const finalName = input.value.trim() || suggestedName;
            appData.metadata.name = finalName;
            const id = saveWebBackup(appData);
